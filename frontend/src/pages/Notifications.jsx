            ...
            {notifications.map((n) => {
              ...
              return (
                ...
                >
                  ...
                  {isUnread && (
                    <div className="absolute left-0 top-0 bottom-0 w-1 bg-indigo-500 rounded-l-xl animate-pulse"></div>
                  )}

                  <div className="flex gap-4">
                    {/* Icon */}
                    <div
                      className={`w-12 h-12 rounded-xl flex items-center justify-center shrink-0 border ${typeStyle.color}`}
                    >
                      <Icon />
                    </div>
                    ...
                    <div className="flex-1">
                      ...
                      <p
                        className={`text-base leading-relaxed ${isUnread ? "text-white font-medium" : "text-gray-400"}`}
                      >
                        {n.message}
                      </p>
                    </div>

    ...
    <div className="relative z-10 max-w-7xl mx-auto px-6 py-8">
      ...
      <div className="bg-blue-500/10 border border-blue-500/20 rounded-2xl p-6 mb-8">
        ...
        <p className="text-gray-400 text-sm">
          You can view your child's exam results, performance analytics, and
          receive important notifications from their coaching center.
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        {menuItems.map((item, i) => (
          ...
          >
            <div
              className={`w-12 h-12 rounded-2xl bg-gradient-to-br ${item.color} flex items-center justify-center mb-4 group-hover:scale-110 transition-transform`}
            >

...
const MyResults = () => {
  ...
  useEffect(() => {
    getAllExams()
      .then((r) =>
        setExams(r.data.data.filter((e) => e.status === "completed")),
      )
      .catch(() => {})
      ...
      <main className="max-w-7xl mx-auto px-6 pt-28 pb-20">
        <div className="mb-8">
          <h1 className="text-3xl font-bold text-white mb-2">
            My <span className="text-purple-400">Results</span>
          </h1>
        ...
        {loading ? (
          ...
          <div className="text-center py-20 border border-dashed border-white/10 rounded-2xl">
            ...
            <p className="text-gray-600 text-sm">
              Your results will appear here after exams are completed
            </p>
          </div>
        ) : (
            ...
            {exams.map((exam) => (
              ...
              >
                <div className="flex justify-between items-start mb-4">
                  <span className="text-xs font-bold px-3 py-1 rounded-full bg-gray-500/10 text-gray-400 border border-gray-500/20">
                    Completed
                  </span>

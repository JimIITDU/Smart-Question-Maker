...
const MockPayment = () => {
  ...
  const handleConfirmPayment = async (e) => {
    ...
    if (!confirm(`Confirm payment of ৳${initialFee} for "${courseTitle}"?`)) return;
      ...
      <div className="min-h-screen bg-[#030712] p-4 md:p-6 flex items-center justify-center">
        <div className="max-w-md w-full">
          <div className="bg-gray-800 rounded-2xl p-8 text-center">
            ...
            <p className="text-gray-400 mb-6">You have successfully enrolled in the course.</p>
        ...
        <div className="bg-gray-800 rounded-2xl overflow-hidden">
          ...
          <div className="px-6 py-4 border-b border-gray-700">
            <div className="flex justify-between items-center">
              ...
              <span className="text-3xl font-bold text-amber-400">৳{initialFee}</span>
            </div>
          </div>
          
          {/* Mock Card Form */}
          <form onSubmit={handleConfirmPayment} className="p-6">
            <p className="text-gray-400 text-sm mb-4">Mock Card Details (any values work)</p>

            ...
            <div className="relative z-10 flex flex-col md:flex-row items-center gap-8">
              ...
              <div className="flex-1 text-center md:text-left">
                ...
                <p className="text-xl text-white/80 font-medium">
                  ...
                  <span className="text-white/40">/ {summary.total_marks}</span>{" "}
                  Marks
                </p>
            ...
            {results.results.map((r, index) => {
              ...
              return (
                ...
                >
                  {/* Status Side Border */}
                  <div
                    className={`absolute left-0 top-0 bottom-0 w-1.5 ${isCorrect ? "bg-emerald-500" : "bg-rose-500"}`}
                  ></div>
                  ...
                  <div className="flex justify-between items-start gap-6">
                    ...
                    <div className="flex-1">
                      <div className="flex items-center gap-3 mb-3 flex-wrap">
                        ...
                        <span
                          className={`text-xs font-bold uppercase tracking-wider px-2 py-0.5 rounded ${isCorrect ? "text-emerald-400 bg-emerald-500/10" : "text-rose-400 bg-rose-500/10"}`}
                        >
                    ...
                    {/* Score Badge */}
                    <div
                      className={`flex-shrink-0 w-16 h-16 rounded-xl flex flex-col items-center justify-center border shadow-sm ${
                        isCorrect
        ...
        {!summary && results?.results?.length === 0 && (
          <div className="flex flex-col items-center justify-center py-20 text-center">
            ...
            <p className="text-gray-500 mb-8">
              It looks like the results haven't been processed yet.
            </p>
            <Link
              to="/exams"

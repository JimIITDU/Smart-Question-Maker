...
const ManageSubjects = () => {
  ...
  const handleDelete = async (id) => {
    ...
    try {
      await fetch(
        `https://smart-question-maker-backend.onrender.com/api/academic/subjects/${id}`,
        {
          method: "DELETE",
      ...
      <main className="max-w-7xl mx-auto px-6 pt-28 pb-20">
        <div className="mb-8">
          <h1 className="text-3xl font-bold text-white mb-2">
            Manage <span className="text-violet-400">Subjects</span>
          </h1>
        ...
        {showForm && (
          ...
          >
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                ...
                <select
                  ...
                  required
                  className="w-full bg-[#0B1120] border border-white/10 text-white rounded-xl px-4 py-3 focus:outline-none focus:border-violet-500"
                >
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full bg-white/5 border border-white/10 text-white rounded-xl px-4 py-3 focus:outline-none focus:border-violet-500"
                />
              </div>
              <div>
                <label className="text-xs font-semibold text-gray-400 uppercase tracking-wider block mb-2">
            ...
            <button
              type="submit"
              className="w-full py-3 bg-gradient-to-r from-violet-600 to-purple-600 text-white rounded-xl font-bold hover:shadow-lg transition-all"
            >
              Create Subject
            </button>
          </form>
            ...
            {subjects.map((subject) => (
              ...
              >
                ...
                <button
                  ...
                  className="w-full flex items-center justify-center gap-2 py-2 bg-red-500/10 text-red-400 border border-red-500/20 rounded-xl text-sm font-semibold hover:bg-red-500/20 transition-all"
                >

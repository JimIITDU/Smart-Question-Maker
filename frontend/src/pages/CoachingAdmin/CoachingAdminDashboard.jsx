...
import { FiHome, FiBook, FiUsers, FiLayers, FiBell, FiUser, FiDollarSign, FiCreditCard, FiUserPlus } from 'react-icons/fi'
...
const CoachingAdminDashboard = () => {
  ...
  return (
    <div className="relative z-10 max-w-7xl mx-auto px-6 py-8">
      <div className="mb-8">
        <h1 className="text-3xl font-bold mb-2"><span className="text-transparent bg-clip-text bg-gradient-to-r from-indigo-400 to-purple-400">Coaching Admin Dashboard</span></h1>

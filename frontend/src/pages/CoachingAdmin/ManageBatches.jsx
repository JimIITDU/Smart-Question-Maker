      ...
      <main className="max-w-7xl mx-auto px-6 pt-28 pb-20">
        <div className="mb-8">
          <h1 className="text-3xl font-bold text-white mb-2">
            Manage <span className="text-purple-400">Batches</span>
          </h1>
            ...
            {batches.map((batch) => (
              ...
              >
                <div className="flex justify-between items-start mb-3">
                  <span
                    className={`px-3 py-1 rounded-full text-xs font-bold border ${statusColor(batch.status)}`}
                  >
                    {batch.status}
                  </span>
                ...
                <div className="flex items-center gap-2 text-sm text-gray-400 mb-4">
                  <FiUsers size={14} />
                  <span>
                    {batch.current_students || 0} / {batch.max_students}{" "}
                    students
                  </span>
                </div>
                <div className="w-full bg-white/10 rounded-full h-1.5 mb-4">
                  <div
                    ...
                    style={{
                      width: `${batch.max_students > 0 ? ((batch.current_students || 0) / batch.max_students) * 100 : 0}%`,
                    }}
                  ></div>
                </div>
                <Link
                  to={`/coaching-admin/students`}
                  className="w-full flex items-center justify-center gap-2 py-2 bg-purple-500/10 text-purple-400 border border-purple-500/20 rounded-xl text-sm font-semibold hover:bg-purple-500/20 transition-all"
                >

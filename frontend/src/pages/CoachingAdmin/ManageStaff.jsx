      ...
      <main className="max-w-7xl mx-auto px-6 pt-28 pb-20">
        <div className="mb-8">
          <h1 className="text-3xl font-bold text-white mb-2">
            Manage <span className="text-rose-400">Staff</span>
          </h1>
        ...
        {showForm && (
          ...
          >
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full flex items-center justify-center gap-2 py-3 bg-gradient-to-r from-rose-600 to-pink-600 text-white rounded-xl font-bold hover:shadow-lg transition-all disabled:opacity-50"
            >
              {loading ? (
        ...
        <div className="text-center py-20 border border-dashed border-white/10 rounded-2xl">
          ...
          <p className="text-gray-600 text-sm">
            Use the button above to add staff accounts
          </p>
        </div>
      </main>
    </div>

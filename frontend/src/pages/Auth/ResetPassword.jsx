...
import { FiLock, FiArrowLeft, FiArrowRight, FiEye, FiEyeOff } from 'react-icons/fi'
...
const ResetPassword = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    setLoading(true)
    try {
      const res = await fetch('https://smart-question-maker-backend.onrender.com/api/auth/reset-password', {
        method: 'POST',
      ...
      <div className="relative w-full max-w-md mx-4 p-1">
        ...
        <div className="relative bg-[#0F172A]/80 backdrop-blur-xl border border-white/10 rounded-2xl shadow-2xl p-8">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-gray-400 text-sm">Enter your OTP and new password</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div className="group">
              <label className="block text-xs font-semibold text-gray-400 uppercase tracking-wider mb-2">OTP Code</label>
              <input
                type="text"
                name="otp"
                value={formData.otp}
            ...
            <div className="group">
              ...
              <div className="relative">
                ...
                />
                <button type="button" onClick={() => setShowPassword(v => !v)} className="absolute inset-y-0 right-0 pr-4 flex items-center text-gray-500 hover:text-white transition-colors">
            ...
            >
              ...
              <span className="relative flex items-center justify-center gap-2">
                {loading ? (
                  ...
                  <><span>Reset Password</span><FiArrowRight className="group-hover:translate-x-1 transition-transform" /></>
                )}
              </span>
            </button>
          </form>

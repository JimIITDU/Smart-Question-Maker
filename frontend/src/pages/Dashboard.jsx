      ...
      <nav className="fixed top-0 w-full z-50 border-b border-white/5 bg-[#0B0C15]/70 backdrop-blur-xl">
        <div className="max-w-6xl mx-auto px-6 h-20 flex justify-between items-center">
          <Link to="/dashboard" className="flex items-center gap-3 group">
            <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-indigo-500 to-cyan-500 flex items-center justify-center text-white font-bold shadow-lg shadow-indigo-500/20 group-hover:shadow-indigo-500/40 transition-all">
              SQ
            </div>
            <div className="flex flex-col">
              <span className="font-bold text-lg tracking-tight leading-none">Smart Question Maker</span>
              <span className="text-xs text-gray-400 tracking-wide uppercase">Academic Suite</span>
            </div>
          </Link>
          ...
          <div className="flex items-center gap-6">
            <div className="hidden md:block text-right">
              ...
              <p className="text-xs text-indigo-400">{getRoleName(user?.role_id)}</p>
            </div>

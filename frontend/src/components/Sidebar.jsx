...
{ path: "/superadmin/manage-subscription-plans", label: "Subscription Plans", icon: FiDollarSign },
    ...
    2: [ // Coaching Admin
      ...
      { path: "/coaching-admin/teacher-applications", label: "Teacher Applications", icon: FiUsers },
      { path: "/coaching-admin/assign-teachers", label: "Assign Teachers", icon: FiUsers },
      ...
      { type: "group", label: "ACADEMIC" },
      { path: "/coaching-admin/analytics", label: "Analytics", icon: FiBarChart2 },
      { type: "group", label: "SETTINGS" },
      { path: "/coaching-admin/settings", label: "Center Settings", icon: FiFileText },

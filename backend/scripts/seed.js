...
async function seed() {
  ...
  try {
    ...
    const centerData = [
      ...
      {
        name: "Alo Coaching Center",
        loc: "Chittagong, Agrabad",
        email: "admin2@gmail.com",
        contact: "01711000002",
        plan: 3,
      },
      {
        name: "Medhabi Pathshala",
        loc: "Sylhet, Zindabazar",
        email: "admin3@gmail.com",
        contact: "01711000003",
        plan: 1,
      },
      {
        name: "Proshno Coaching",
        loc: "Rajshahi, Shaheb Bazar",
    ...
    for (let i = 0; i < 30; i++) {
      ...
      const {
        ...
        [
          ...
          studentClass[i],
          gn,
          centerIds[studentCi[i]],
          i % 2 === 0 ? "Male" : "Female",
          `Parent of ${studentNames[i]}`,
          `016${pad(i + 100)}`,
        ],
      );
    ...
    for (let i = 0; i < 10; i++) {
      const {
        ...
        [
          `parent${i + 1}@gmail.com`,
          PASS,
          parentNames[i],
          `016${pad(i + 200)}`,
          centerIds[Math.floor(i / 2)],
        ],
      );
    ...
    const courseData = [
      {
        title: "HSC Science Complete",
        desc: "Full HSC Science with Physics, Chemistry, Biology, Math",
        dur: "12 months",
        fee: 5000,
        ci: 0,
      },
      {
        title: "SSC General Complete",
        desc: "SSC General with all core subjects",
        dur: "10 months",
        fee: 3500,
        ci: 0,
      },
      {
        ...
        desc: "Accounting, Business English, Economics",
        dur: "12 months",
        fee: 4500,
        ci: 0,
      },
      {
        title: "JSC Mathematics Special",
        desc: "JSC Mathematics intensive preparation",
        dur: "6 months",
        fee: 2000,
        ci: 1,
      },
      {
        ...
        desc: "History, Civics, Bengali, English",
        dur: "12 months",
        fee: 4000,
        ci: 1,
      },
      {
        title: "SSC Science",
        desc: "SSC Physics, Chemistry, Biology, Math",
        dur: "10 months",
        fee: 3800,
        ci: 1,
      },
      {
        ...
        desc: "Advanced English communication and grammar",
        dur: "3 months",
        fee: 1500,
        ci: 2,
      },
      {
        ...
        desc: "Full IELTS Reading, Writing, Listening, Speaking",
        dur: "4 months",
        fee: 8000,
        ci: 2,
      },
      {
        title: "Medical Admission Prep",
        desc: "Biology, Chemistry for medical college admission",
        dur: "8 months",
        fee: 12000,
        ci: 2,
      },
      {
        ...
        desc: "Math, Physics for engineering university admission",
        dur: "8 months",
        fee: 10000,
        ci: 3,
      },
      {
        ...
        desc: "GK, Math, English, Bangla for BCS",
        dur: "12 months",
        fee: 6000,
        ci: 3,
      },
      {
        ...
        desc: "Classes 1-5 all subjects support",
        dur: "6 months",
        fee: 1200,
        ci: 3,
      },
      {
        ...
        desc: "O Level Pure Math and Statistics",
        dur: "9 months",
        fee: 7000,
        ci: 4,
      },
      {
        ...
        desc: "A Level Mechanics, Waves, Electricity",
        dur: "9 months",
        fee: 7500,
        ci: 4,
      },
      {
        ...
        desc: "GRE Quantitative and Verbal Reasoning",
        dur: "3 months",
        fee: 9000,
        ci: 4,
      },
    ...
    for (const [bi, sis] of enrollMap) {
      for (const si of sis) {
        ...
        await client.query(
          `UPDATE batch SET current_students=current_students+1 WHERE batch_id=$1`,
          [batchIds[bi]],
        );
      }
    }
    ...
    const questions = [
      ...
      // Chapter 1: Real Numbers
      {
        ...
        si: 0,
        co: 0,
        class_name: "11-12(Higher Secondary)",
        paper: "1st",
        chapter: "1",
      ...
      },
      {
        ...
        text: "Prove that √2 is irrational using contradiction.",
        type: "descriptive",
        diff: "hard",
        answer:
          "Assume √2=p/q in lowest terms. Then p²=2q², so p is even, write p=2k. Then 4k²=2q², q²=2k², so q is also even. This contradicts p/q being in lowest terms. Therefore √2 is irrational.",
        marks: 5,
        ti: 0,
      },
      ...
      // Chapter 2: Algebra
      {
        ...
        text: "If x²−5x+6=0, the roots are:",
        type: "mcq",
        diff: "medium",
        a: "1 and 6",
        b: "2 and 3",
      ...
      },
      {
        ...
        chapter_name: "Algebra",
        topic: "Polynomials",
        text: "Degree of polynomial 3x³+2x²−x+5 is:",
        type: "mcq",
        diff: "easy",
        a: "1",
        b: "2",
      ...
      },
      {
        ...
        chapter_name: "Algebra",
        topic: "Quadratic Equations",
        text: "Every quadratic equation has exactly two distinct real roots.",
        type: "true_false",
        diff: "medium",
        a: "True",
        b: "False",
      ...
      },
      {
        ...
        chapter_name: "Algebra",
        topic: "Quadratic Equations",
        text: "Solve x²−5x+6=0 showing all steps using the factorization method.",
        type: "descriptive",
        diff: "medium",
        answer:
          "x²−5x+6=0 → (x−2)(x−3)=0 → x=2 or x=3. Verification: 4−10+6=0 ✓ and 9−15+6=0 ✓",
        marks: 4,
        ti: 0,
      },
      ...
      },
      {
        ...
        chapter_name: "Trigonometry",
        topic: "Trigonometric Identities",
        text: "sin²θ + cos²θ = 1 is a fundamental identity.",
        type: "true_false",
        diff: "easy",
        a: "True",
        b: "False",
      ...
      },
      {
        ...
        chapter_name: "Calculus",
        topic: "Differentiation",
        text: "Derivative of a constant is:",
        type: "mcq",
        diff: "easy",
        a: "1",
        b: "Infinity",
      ...
      },
      {
        ...
        chapter_name: "Calculus",
        topic: "Differentiation",
        text: "Find dy/dx if y = 3x⁴ − 2x² + 5x − 7, showing all steps.",
        type: "descriptive",
        diff: "hard",
        answer:
          "dy/dx = 12x³ − 4x + 5. Using power rule: d/dx(3x⁴)=12x³, d/dx(2x²)=4x, d/dx(5x)=5, d/dx(7)=0.",
        marks: 5,
        ti: 0,
      },
      ...
      },
      {
        ...
        chapter_name: "Coordinate Geometry",
        topic: "Circle",
        text: "Area of circle with radius 7 is:",
        type: "mcq",
        diff: "easy",
        a: "22π",
        b: "49π",
      ...
      },
      {
        ...
        chapter_name: "Coordinate Geometry",
        topic: "Straight Lines",
        text: "Two parallel lines have equal slopes.",
        type: "true_false",
        diff: "easy",
        a: "True",
        b: "False",
      ...
      // Chapter 1: Mechanics
      {
        ...
        topic: "Newton's Laws",
        text: "Newton's second law states F = ?",
        type: "mcq",
        diff: "easy",
        a: "mv",
        b: "ma",
      ...
      },
      {
        ...
        chapter_name: "Mechanics",
        topic: "Newton's Laws",
        text: "A body of mass 5 kg acted on by 20 N. Acceleration = ?",
        type: "mcq",
        diff: "medium",
        a: "2 m/s²",
        b: "4 m/s²",
      ...
      },
      {
        ...
        chapter_name: "Mechanics",
        topic: "Gravity",
        text: "Value of g on Earth surface is approximately:",
        type: "mcq",
        diff: "easy",
        a: "8.9 m/s²",
        b: "9.8 m/s²",
      ...
      },
      {
        ...
        chapter_name: "Mechanics",
        topic: "Newton's Laws",
        text: "Every action has an equal and opposite reaction — Newton's 3rd Law.",
        type: "true_false",
        diff: "easy",
        a: "True",
        b: "False",
      ...
      },
      {
        ...
        chapter_name: "Mechanics",
        topic: "Newton's Laws",
        text: "Describe Newton's three laws of motion with one real-life example for each.",
        type: "descriptive",
        diff: "hard",
        answer:
          "1st: Inertia — passenger pushed back in accelerating car. 2nd: F=ma — heavier object needs more force. 3rd: Rocket propulsion — exhaust pushes backward, rocket moves forward.",
        marks: 6,
        ti: 1,
      },
      ...
      // Chapter 2: Waves and Sound
      {
        ...
        paper: "1st",
        chapter: "2",
        chapter_name: "Waves and Sound",
        topic: "Sound",
        text: "Speed of sound in air at room temperature is approximately:",
        type: "mcq",
        diff: "easy",
        a: "100 m/s",
        b: "343 m/s",
      ...
      },
      {
        ...
        chapter_name: "Waves and Sound",
        topic: "Waves",
        text: "Explain the difference between transverse and longitudinal waves with examples.",
        type: "descriptive",
        diff: "medium",
        answer:
          "Transverse waves: particles oscillate perpendicular to wave direction. Example: light waves. Longitudinal waves: particles oscillate parallel to wave direction. Example: sound waves.",
        marks: 4,
        ti: 1,
      },
      ...
      },
      {
        ...
        chapter_name: "Optics",
        topic: "Reflection",
        text: "Light travels in a straight line in a uniform medium.",
        type: "true_false",
        diff: "easy",
        a: "True",
        b: "False",
      ...
      },
      {
        ...
        chapter_name: "Electricity",
        topic: "Current",
        text: "Electric current flows from negative to positive terminal inside a battery.",
        type: "true_false",
        diff: "medium",
        a: "True",
        b: "False",
      ...
      // ═══════════════════════════════════════════════════════════════════
      {
        ...
        text: "Atomic number of Carbon is:",
        type: "mcq",
        diff: "easy",
        a: "4",
        b: "6",
      ...
      },
      {
        ...
        text: "Valence electrons of Sodium (Na) is:",
        type: "mcq",
        diff: "easy",
        a: "1",
        b: "2",
      ...
      },
      {
        ...
        topic: "Covalent Bond",
        text: "Type of bond in H₂O molecule is:",
        type: "mcq",
        diff: "medium",
        a: "Ionic",
        b: "Covalent",
      ...
      },
      {
        ...
        chapter_name: "Acids Bases and Salts",
        topic: "pH Scale",
        text: "An acidic solution has pH less than 7.",
        type: "true_false",
        diff: "easy",
        a: "True",
        b: "False",
      ...
      },
      {
        ...
        chapter_name: "Gases",
        topic: "Gas Laws",
        text: "Most abundant gas in the atmosphere is:",
        type: "mcq",
        diff: "easy",
        a: "Oxygen",
        b: "Nitrogen",
      ...
      },
      {
        ...
        chapter_name: "Gases",
        topic: "Gas Laws",
        text: "Molecular weight of CO₂ is:",
        type: "mcq",
        diff: "medium",
        a: "40",
        b: "44",
      ...
      },
      {
        ...
        text: "A catalyst works by lowering the activation energy of a reaction.",
        type: "true_false",
        diff: "medium",
        a: "True",
        b: "False",
      ...
      },
      {
        ...
        chapter_name: "Chemical Kinetics",
        topic: "Catalysts",
        text: "Explain the role of a catalyst in a chemical reaction with one example.",
        type: "descriptive",
        diff: "medium",
        answer:
          "A catalyst lowers activation energy without being consumed. Example: MnO₂ in decomposition of H₂O₂: 2H₂O₂ → 2H₂O + O₂. MnO₂ speeds this up without being used up.",
        marks: 4,
        ti: 1,
      },
      {
      ...
      },
      {
        ...
        chapter_name: "Genetics",
        topic: "Chromosomes",
        text: "Normal human body cells contain how many chromosomes?",
        type: "mcq",
        diff: "medium",
        a: "44",
        b: "46",
      ...
      },
      {
        ...
        text: "Equation: 6CO₂+6H₂O+light → C₆H₁₂O₆+6O₂ represents photosynthesis.",
        type: "true_false",
        diff: "easy",
        a: "True",
        b: "False",
      ...
      },
      {
        ...
        chapter_name: "Cell Division",
        topic: "Photosynthesis",
        text: "Describe the process of photosynthesis including the light and dark reactions.",
        type: "descriptive",
        diff: "hard",
        answer:
          "Photosynthesis: 6CO₂+6H₂O+light→C₆H₁₂O₆+6O₂. Light reactions in thylakoid: ATP and NADPH produced. Dark reactions (Calvin cycle) in stroma: CO₂ fixed into glucose using ATP and NADPH.",
        marks: 6,
        ti: 1,
      },
      ...
      },
      {
        ...
        chapter_name: "Grammar",
        topic: "Tenses",
        text: '"I have eaten" is in which tense?',
        type: "mcq",
        diff: "medium",
        a: "Simple Past",
        b: "Present Perfect",
      ...
      },
      {
        ...
        chapter_name: "Grammar",
        topic: "Subject-Verb Agreement",
        text: '"She don\'t know" is grammatically correct.',
        type: "true_false",
        diff: "easy",
        a: "True",
        b: "False",
      ...
      },
      {
        ...
        text: "Write a paragraph (100 words) on the importance of education.",
        type: "descriptive",
        diff: "medium",
        answer:
          "Education is the cornerstone of development. It equips individuals with knowledge, critical thinking skills, and the ability to contribute meaningfully to society. Education opens doors to career opportunities, improves quality of life, and fosters social equality. In Bangladesh, education has been central to national progress since independence. Every child deserves access to quality education.",
        marks: 10,
        ti: 2,
      },
      ...
      // ═══════════════════════════════════════════════════════════════════
      {
        ...
        si: 5,
        co: 1,
        class_name: "9-10 (Secondary)",
        paper: "1st",
        chapter: "1",
        chapter_name: "Literature",
        topic: "Bengali Literature",
        text: "রবীন্দ্রনাথ ঠাকুর নোবেল পুরস্কার পান কত সালে?",
        type: "mcq",
        diff: "medium",
        a: "1910",
        b: "1913",
      ...
      },
      {
        ...
        paper: "1st",
        chapter: "1",
        chapter_name: "Language",
        topic: "Bengali Alphabet",
      ...
      },
      {
        ...
        chapter_name: "Language",
        topic: "Etymology",
        text: "বাংলা ভাষা ইন্দো-ইউরোপীয় ভাষা পরিবারের অন্তর্গত।",
        type: "true_false",
        diff: "medium",
        a: "True",
        b: "False",
      ...
      },
      {
        ...
        chapter_name: "Writing",
        topic: "Essay",
        text: "বাংলাদেশের স্বাধীনতা দিবস সম্পর্কে একটি অনুচ্ছেদ লেখো।",
        type: "descriptive",
        diff: "medium",
        answer:
          "বাংলাদেশ ১৯৭১ সালের ২৬ মার্চ স্বাধীনতা ঘোষণা করে। নয় মাসের মুক্তিযুদ্ধের পর ১৬ ডিসেম্বর চূড়ান্ত বিজয় অর্জিত হয়। লক্ষ শহীদের আত্মত্যাগের বিনিময়ে অর্জিত এই স্বাধীনতা আমাদের জাতীয় গর্ব।",
        marks: 5,
        ti: 2,
      },
      ...
      },
      {
        ...
        text: "Area of a rectangle 5×8 is:",
        type: "mcq",
        diff: "easy",
        a: "13",
        b: "40",
      ...
      },
      {
        ...
        chapter_name: "Geometry",
        topic: "Triangles",
        text: "Sum of angles in a triangle is 180°.",
        type: "true_false",
        diff: "easy",
        a: "True",
        b: "False",
      ...
      },
      {
        ...
        chapter_name: "Statistics",
        topic: "Mean",
        text: "Find the mean and median of: 5, 3, 8, 1, 9, 4, 7.",
        type: "descriptive",
        diff: "medium",
        answer:
          "Sorted: 1,3,4,5,7,8,9. Mean=(1+3+4+5+7+8+9)/7=37/7≈5.29. Median=5 (middle value).",
        marks: 4,
        ti: 3,
      },
      ...
      },
      {
        ...
        text: "Conservation of energy means energy is neither created nor destroyed.",
        type: "true_false",
        diff: "easy",
        a: "True",
        b: "False",
      ...
      },
      {
        ...
        topic: "Induction",
        text: "Electromagnetic induction was discovered by:",
        type: "mcq",
        diff: "hard",
        a: "Newton",
        b: "Faraday",
      ...
      },
      {
        ...
        paper: "1st",
        chapter: "1",
        chapter_name: "World Literature",
        topic: "Famous Works",
        text: '"War and Peace" was written by:',
        type: "mcq",
        diff: "medium",
        a: "Dostoyevsky",
        b: "Tolstoy",
      ...
      },
      {
        ...
        paper: "1st",
        chapter: "2",
        chapter_name: "Bangladesh History",
        topic: "Independence",
        text: "Bangladesh declared independence on 26 March 1971.",
        type: "true_false",
        diff: "easy",
        a: "True",
        b: "False",
      ...
      },
      {
        ...
        chapter_name: "Bangladesh History",
        topic: "Independence",
        text: "Describe the significance of 26 March 1971 in the history of Bangladesh.",
        type: "descriptive",
        diff: "medium",
        answer:
          "26 March 1971 is Bangladesh's Independence Day. After years of political oppression, Bangabandhu Sheikh Mujibur Rahman declared independence. The liberation war lasted 9 months resulting in the birth of Bangladesh on 16 December 1971.",
        marks: 6,
        ti: 5,
      },
      ...
      },
      {
        ...
        chapter_name: "Mechanics",
        topic: "Motion",
        text: "An object at rest has zero velocity.",
        type: "true_false",
        diff: "easy",
        a: "True",
        b: "False",
      ...
      },
      {
        ...
        chapter_name: "Light",
        topic: "Reflection",
        text: "Angle of incidence equals angle of reflection in a plane mirror.",
        type: "true_false",
        diff: "easy",
        a: "True",
        b: "False",
      ...
      },
      {
        ...
        paper: "1st",
        chapter: "2",
        chapter_name: "Compounds",
        topic: "Salts",
        text: "Formula for common salt (NaCl) is:",
        type: "mcq",
        diff: "easy",
        a: "HCl",
        b: "NaCl",
      ...
      },
      {
        ...
        chapter_name: "Atomic Structure",
        topic: "Oxygen",
        text: "Oxygen has atomic number 8.",
        type: "true_false",
        diff: "easy",
        a: "True",
        b: "False",
      ...
      // ═══════════════════════════════════════════════════════════════════
      {
        ...
        si: 14,
        co: 6,
        class_name: "Bachelor(pass)",
        paper: "1st",
        chapter: "1",
        chapter_name: "Advanced Grammar",
        topic: "Passive Voice",
        text: 'Passive voice of "He wrote a letter" is:',
        type: "mcq",
        diff: "medium",
        a: "A letter wrote",
      ...
      },
      {
        ...
        chapter_name: "Grammar",
        topic: "Articles",
        text: '"The" is a definite article.',
        type: "true_false",
        diff: "easy",
        a: "True",
        b: "False",
      ...
      },
      {
        ...
        paper: "2nd",
        chapter: "3",
        chapter_name: "Speaking",
        topic: "Self Introduction",
        text: "Write a 100-word self introduction for a job interview.",
        type: "descriptive",
        diff: "medium",
        answer:
          "Good morning. My name is [Name]. I completed my graduation from [University] in [Subject]. I have [X] years of experience in [field]. I am passionate about [interest] and have strong skills in [skills]. I am a team player, quick learner, and detail-oriented professional. I am excited about this opportunity to contribute to your organization.",
        marks: 5,
        ti: 6,
      },
      ...
      // ═══════════════════════════════════════════════════════════════════
      {
        ...
        si: 15,
        co: 7,
        class_name: "Bachelor(hons)",
        paper: "1st",
        chapter: "1",
        chapter_name: "IELTS Structure",
        topic: "Reading",
        text: "IELTS Academic Reading has how many sections?",
        type: "mcq",
        diff: "easy",
        a: "2",
        b: "3",
      ...
      },
      {
        ...
        paper: "1st",
        chapter: "1",
        chapter_name: "IELTS Scoring",
        topic: "Band Scores",
        text: "IELTS Band 9 means:",
        type: "mcq",
        diff: "easy",
        a: "Excellent User",
        b: "Good User",
      ...
      },
      {
        ...
        topic: "Skimming",
        text: "Skimming means reading for specific information only.",
        type: "true_false",
        diff: "medium",
        a: "True",
        b: "False",
      ...
      },
      {
        ...
        text: "Describe three strategies for improving IELTS Reading performance.",
        type: "descriptive",
        diff: "medium",
        answer:
          "1. Skimming: Read quickly for general idea. 2. Scanning: Search for specific information. 3. Prediction: Use headings to predict content before reading. Practice with timed passages to improve speed and accuracy.",
        marks: 5,
        ti: 7,
      },
      ...
      // ═══════════════════════════════════════════════════════════════════
      {
        ...
        chapter: "1",
        chapter_name: "Task 1",
        topic: "Task 1 Requirements",
        text: "IELTS Task 1 minimum word count is:",
        type: "mcq",
        diff: "easy",
        a: "100",
        b: "150",
      ...
      },
      {
        ...
        chapter: "2",
        chapter_name: "Task 2",
        topic: "Task 2 Requirements",
        text: "IELTS Task 2 minimum word count is:",
        type: "mcq",
        diff: "easy",
        a: "200",
        b: "250",
      ...
      },
      {
        ...
        chapter_name: "Task 2",
        topic: "Essay Writing",
        text: 'Write an IELTS Task 2 introduction for: "Technology is replacing human workers. Is this a positive or negative development?"',
        type: "descriptive",
        diff: "hard",
        answer:
          "In recent decades, technological advancement has increasingly displaced human labor across various industries. While some argue this represents progress and efficiency, others contend it creates unemployment and social inequality. This essay will examine both perspectives before reaching a reasoned conclusion.",
        marks: 8,
        ti: 7,
      },
      ...
      },
      {
        ...
        paper: "1st",
        chapter: "2",
        chapter_name: "Human Biology",
        topic: "Blood",
        text: "Red blood cells are produced in:",
        type: "mcq",
        diff: "medium",
        a: "Liver",
        b: "Bone marrow",
      ...
      },
      {
        ...
        chapter_name: "Human Biology",
        topic: "Blood",
        text: "Normal adult human heart beats about 72 times per minute.",
        type: "true_false",
        diff: "easy",
        a: "True",
        b: "False",
      ...
      },
      {
        ...
        text: "Photosynthesis releases CO₂.",
        type: "true_false",
        diff: "medium",
        a: "True",
        b: "False",
      ...
      },
      {
        ...
        chapter_name: "Genetics",
        topic: "Heredity",
        text: "Describe the structure of DNA and its role in heredity.",
        type: "descriptive",
        diff: "hard",
        answer:
          "DNA is a double helix made of nucleotides (phosphate, deoxyribose, nitrogenous base). Base pairs: A-T, G-C. During reproduction, DNA replicates to pass genetic information to offspring. Genes encoded in DNA sequence determine traits.",
        marks: 6,
        ti: 8,
      },
      ...
      // ═══════════════════════════════════════════════════════════════════
      {
        ...
        chapter_name: "Chemical Bonding",
        topic: "Bond Strength",
        text: "Which is the strongest chemical bond?",
        type: "mcq",
        diff: "hard",
        a: "Ionic",
        b: "Covalent",
      ...
      },
      {
        ...
        topic: "Enzymes",
        text: "Explain the role of enzymes in biological reactions.",
        type: "descriptive",
        diff: "hard",
        answer:
          "Enzymes are biological catalysts (proteins) that lower activation energy. They are substrate-specific (lock-and-key model). Example: Amylase breaks down starch into sugars in saliva. Factors affecting enzyme activity: temperature, pH, substrate concentration.",
        marks: 6,
        ti: 8,
      },
      ...
      },
      {
        ...
        chapter_name: "Linear Algebra",
        topic: "Matrices",
        text: "A square matrix has equal number of rows and columns.",
        type: "true_false",
        diff: "easy",
        a: "True",
        b: "False",
      ...
      },
      {
        ...
        topic: "ODE",
        text: "Solve dy/dx = 2x and find y with initial condition y(0)=3.",
        type: "descriptive",
        diff: "hard",
        answer:
          "Integrating: y = ∫2x dx = x²+C. Applying y(0)=3: 3=0+C, so C=3. Therefore y = x²+3.",
        marks: 5,
        ti: 9,
      },
      ...
      },
      {
        ...
        topic: "Laws",
        text: "Energy cannot be created or destroyed — First Law of Thermodynamics.",
        type: "true_false",
        diff: "easy",
        a: "True",
        b: "False",
      ...
      // ═══════════════════════════════════════════════════════════════════
      {
        ...
        chapter_name: "Bangladesh History",
        topic: "Independence",
        text: "Bangladesh declared independence in which year?",
        type: "mcq",
        diff: "easy",
        a: "1969",
        b: "1971",
      ...
      },
      {
        ...
        topic: "Oceans",
        text: "Largest ocean in the world is:",
        type: "mcq",
        diff: "easy",
        a: "Atlantic",
        b: "Pacific",
      ...
      },
      {
        ...
        paper: "1st",
        chapter: "2",
        chapter_name: "International Organizations",
        topic: "UN",
        text: "United Nations was founded in:",
        type: "mcq",
        diff: "easy",
        a: "1944",
        b: "1945",
      ...
      },
      {
        ...
        text: "Write a short note on the Liberation War of Bangladesh 1971.",
        type: "descriptive",
        diff: "medium",
        answer:
          "Bangladesh Liberation War began on 26 March 1971 when Bangabandhu declared independence. Pakistani forces launched Operation Searchlight on Dhaka. Mukti Bahini fought for 9 months. India intervened on 3 December. Pakistan surrendered on 16 December 1971 — Victory Day. Approximately 3 million martyred.",
        marks: 8,
        ti: 11,
      },
      ...
      },
      {
        ...
        paper: "1st",
        chapter: "2",
        chapter_name: "Finance Math",
        topic: "Simple Interest",
        text: "Simple interest formula is:",
        type: "mcq",
        diff: "medium",
        a: "PRT",
        b: "PRT/100",
      ...
      },
      {
        ...
        text: "A fair coin is tossed. What is the probability of getting heads?",
        type: "mcq",
        diff: "easy",
        a: "1/4",
        b: "1/2",
      ...
      },
      {
        ...
        paper: "1st",
        chapter: "2",
        chapter_name: "General Knowledge",
        topic: "Calendar",
        text: "Days in a week:",
        type: "mcq",
        diff: "easy",
      ...
      },
      {
        ...
        chapter_name: "General Knowledge",
        topic: "Alphabet",
        text: "Letters in English alphabet:",
        type: "mcq",
        diff: "easy",
        a: "24",
        b: "26",
      ...
      },
      {
        ...
        chapter_name: "Geometry",
        topic: "Pythagoras",
        text: "In a right triangle with legs 3 and 4, hypotenuse = ?",
        type: "mcq",
        diff: "medium",
        a: "4",
        b: "5",
      ...
      },
      {
        ...
        topic: "Functions",
        text: "Explain the concept of a function and give two examples.",
        type: "descriptive",
        diff: "medium",
        answer:
          "A function f: A→B assigns exactly one output in B to each input in A. Example 1: f(x)=x² maps real numbers to non-negative reals. Example 2: f(x)=2x+1 is a linear function. Key property: each input has exactly one output.",
        marks: 5,
        ti: 12,
      },
      ...
      // ═══════════════════════════════════════════════════════════════════
      {
        ...
        text: "Standard deviation measures the spread of data.",
        type: "true_false",
        diff: "easy",
        a: "True",
        b: "False",
      ...
      },
      {
        ...
        chapter_name: "Probability",
        topic: "Statistics",
        text: "Calculate mean, median, mode for: 3, 5, 7, 5, 9, 3, 5, 8.",
        type: "descriptive",
        diff: "medium",
        answer:
          "Sorted: 3,3,5,5,5,7,8,9. Mean=(3+3+5+5+5+7+8+9)/8=45/8=5.625. Median=(5+5)/2=5. Mode=5 (appears 3 times).",
        marks: 4,
        ti: 12,
      },
      ...
      // ═══════════════════════════════════════════════════════════════════
      {
        ...
        chapter_name: "Mechanics",
        topic: "SHM",
        text: "Simple harmonic motion is a type of periodic motion.",
        type: "true_false",
        diff: "medium",
        a: "True",
        b: "False",
      ...
      },
      {
        ...
        text: "Moment of inertia depends on:",
        type: "mcq",
        diff: "hard",
        a: "Mass only",
        b: "Mass and its distribution",
        c: "Volume",
        d: "Velocity",
        correct: "B",
        marks: 3,
      ...
      },
      {
        ...
        text: "Derive the expression for centripetal acceleration.",
        type: "descriptive",
        diff: "hard",
        answer:
          "For circular motion of radius r and speed v: a=v²/r directed towards center. Proof: velocity vector changes direction, rate of change = v×(v/r) = v²/r. In terms of angular velocity ω: a=ω²r.",
        marks: 6,
        ti: 13,
      },
      ...
      // ═══════════════════════════════════════════════════════════════════
      {
        ...
        paper: "1st",
        chapter: "1",
        chapter_name: "Wave Properties",
        topic: "Doppler Effect",
        text: "Doppler effect is the change in frequency due to relative motion between source and observer.",
        type: "true_false",
        diff: "hard",
        a: "True",
        b: "False",
      ...
      },
      {
        ...
        chapter_name: "Waves",
        topic: "Diffraction",
        text: "Diffraction occurs when a wave:",
        type: "mcq",
        diff: "hard",
        a: "Passes through an opening or around an obstacle",
        b: "Reflects off a surface",
        c: "Refracts through a medium",
        d: "Gets absorbed",
        correct: "A",
        marks: 3,
        ti: 13,
      },
      {
        ...
        chapter_name: "Waves",
        topic: "Interference",
        text: "Explain constructive and destructive interference with diagrams description.",
        type: "descriptive",
        diff: "hard",
        answer:
          "Constructive: two waves in phase, amplitudes add → larger amplitude. Condition: path difference = nλ. Destructive: waves out of phase, amplitudes cancel → zero. Condition: path difference = (n+½)λ. Example: Young's double slit experiment.",
        marks: 6,
        ti: 13,
      },
      ...
      // ═══════════════════════════════════════════════════════════════════
      {
        ...
        paper: "1st",
        chapter: "1",
        chapter_name: "GRE Structure",
        topic: "Test Format",
        text: "GRE Quantitative Reasoning has how many sections?",
        type: "mcq",
        diff: "easy",
        a: "1",
        b: "2",
      ...
      },
      {
        ...
        paper: "1st",
        chapter: "1",
        chapter_name: "GRE Scoring",
        topic: "Score Range",
        text: "GRE Quantitative score range is:",
        type: "mcq",
        diff: "easy",
        a: "0-300",
        b: "130-170",
      ...
      },
      {
        ...
        topic: "Statistics",
        text: "GRE tests include Data Interpretation questions.",
        type: "true_false",
        diff: "easy",
        a: "True",
        b: "False",
      ...
      },
      {
        ...
        chapter_name: "Algebra",
        topic: "Word Problems",
        text: "A store sells 120 items at $5 each. If 15% discount is given, total revenue = ?",
        type: "mcq",
        diff: "medium",
        a: "$510",
        b: "$500",
      ...
      },
      {
        ...
        paper: "2nd",
        chapter: "3",
        chapter_name: "Problem Solving",
        topic: "GRE Strategy",
        text: "Describe your approach to solving a GRE Data Interpretation question.",
        type: "descriptive",
        diff: "hard",
        answer:
          "1. Read graph/table title carefully. 2. Note units and scale. 3. Identify what each question asks. 4. Extract only relevant data. 5. Estimate before calculating. 6. Check answer choices for reasonableness. Always manage time: ~2 minutes per question.",
        marks: 5,
        ti: 14,
      },
      ...
      },
      {
        ...
        chapter_name: "Geometry",
        topic: "Triangles",
        text: "A right angle is equal to 90°.",
        type: "true_false",
        diff: "easy",
        a: "True",
        b: "False",
      ...
      },
      {
        ...
        text: "A shopkeeper buys at ৳100 and sells at ৳120. Profit percentage is:",
        type: "mcq",
        diff: "medium",
        a: "10%",
        b: "20%",
      ...
      },
      {
        ...
        paper: "1st",
        chapter: "2",
        chapter_name: "Double Entry System",
      ...
      },
      {
        ...
        chapter_name: "Introduction to Accounting",
        topic: "Assets",
        text: "Land and building are examples of:",
        type: "mcq",
        diff: "easy",
        a: "Current assets",
        b: "Fixed assets",
      ...
      },
      {
        ...
        paper: "2nd",
        chapter: "3",
        chapter_name: "Financial Statements",
        topic: "Balance Sheet",
        text: "Explain the difference between assets and liabilities with examples.",
        type: "descriptive",
        diff: "medium",
        answer:
          "Assets: Resources owned by the business. Current assets (cash, stock) and fixed assets (land, machinery). Liabilities: Obligations to others. Current (creditors, bank overdraft) and long-term (loans). Assets = Liabilities + Capital.",
        marks: 5,
        ti: 2,
      },
    ]; // end questions array
    ...
    const examData = [
      {
        ...
        type: "regular",
        ti: 0,
        title: "Mathematics Mid Term 2024",
        dur: 90,
        status: "completed",
      },
      {
      ...
      },
      {
        ...
        type: "live_quiz",
        ti: 2,
        title: "English Grammar Live Quiz",
        dur: 30,
        status: "completed",
      },
      {
      ...
      },
      {
        ...
        type: "live_quiz",
        ti: 0,
        title: "Mathematics Live Quiz Session",
        dur: 20,
        status: "ongoing",
      },
    ];
    ...
    const notifData = [
      ...
      [
        adminIds[0],
        "Monthly subscription payment confirmed. ৳999 received.",
        "fee",
      ],
      [
        adminIds[0],
        "New batch HSC Science Batch A created successfully.",
        "system",
      ],
      [
        adminIds[0],
        "Student enrollment: 6/30 in HSC Science Batch A.",
        "system",
      ],
      [adminIds[1], "Alo Coaching Center is now active.", "system"],
      [
        adminIds[1],
        "Pro subscription activated. All features unlocked.",
        "system",
      ],
      ...
      [
        teacherIds[0],
        "5 students submitted Mathematics Final answers.",
        "exam",
      ],
      [teacherIds[1], "Welcome to Excellence Coaching Center!", "system"],
      [
        teacherIds[1],
        "Physics Unit Test 1 completed. 5 submissions received.",
        "exam",
      ],
      [
        teacherIds[2],
        "English Grammar Live Quiz completed successfully.",
        "quiz",
      ],
      [teacherIds[3], "JSC Mathematics Test results ready to publish.", "exam"],
      [
        teacherIds[4],
        "SSC Physics Live Quiz completed. 3 students participated.",
        "quiz",
      ],
      ...
      [
        studentIds[0],
        "Welcome to Smart Coaching! Your account is ready.",
        "system",
      ],
      ...
      [
        studentIds[1],
        "English Grammar Live Quiz starts in 30 minutes!",
        "quiz",
      ],
      ...
      [
        studentIds[5],
        "Your Math score: 3/10. Please review the material.",
        "exam",
      ],
      ...
      [
        parentIds[0],
        "Alice Ahmed scored 80% in Mathematics Mid Term 2024.",
        "exam",
      ],
    ...
    console.log(
      "  teacher@gmail.com        → Teacher         (Math/Physics, Excellence)",
    );
    console.log(
      "  teacher2-15@gmail.com    → Teachers        (various subjects)",
    );
    console.log("  staff@gmail.com          → Staff           (Excellence)");
    console.log(
      "  staff2-5@gmail.com       → Staff           (various centers)",
    );
    console.log("  student1@gmail.com       → Student         (Excellence)");
    console.log(
      "  student2-30@gmail.com    → Students        (various centers)",
    );
    ...
    console.log(
      `  ${questionIds.length}  Questions  (MCQ + T/F + Descriptive)`,
    );
    console.log(
      `       → All with class_name, paper, chapter, chapter_name, topic`,
    );
